...
const options = [
  ...
  },
  {
    ...
    description:
      "We offer a unique solution built just for plumbers. We share the risk by guaranteeing our results, so we're highly motivated to deliver. No generic claims, no guesswork—just a clear focus on getting you to the top and making your phone ring.",
  },
];
