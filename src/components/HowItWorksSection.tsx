...
const steps = [
  {
    ...
    description:
      "We choose the postcodes and search terms that bring you the highest-paying roofer jobs.",
  },
  {
    icon: TrendingUp,
    number: "02",
  ...
  },
  {
    ...
    description:
      "Direct, exclusive calls come straight to you. Not shared leads, not tyre-kickers. Real roofer jobs.",
  },
];
